...
(function (assetRespBuilder) {
    ...
    assetRespBuilder.buildAssetDetailModel = function (data) {
        ...
        if (!utils.checkNullEmptyObject(data.entity)) {
            model.entity.entity_id = entity.id;
            model.entity.name = entity.nm;
            model.entity.country = entity.ctr;
            model.entity.state = entity.st;
            model.entity.district = entity.ds;
            model.entity.city = entity.ct;
            model.entity.taluk = entity.tlk;
        }
        return model;
    };
})(module.exports);
