...
(function (assetResBuilder) {
    ...
    assetResBuilder.buildAssetData = function (aData, tempData, offset) {
    ...
    assetResBuilder.buildRecentAlertModel = function (data) {
    ...
    assetResBuilder.buildAssetTempDataModel = function (data, queryModel) {
        var recordCounter = 0,
            tempAlertModel = new deviceTempAlertModel(),
